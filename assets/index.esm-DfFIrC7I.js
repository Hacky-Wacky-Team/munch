import{g as hm,_ as ql,a as dm,F as fm,b as yt,L as mm,c as ue,d as as,e as sa,p as Bl,u as gm,f as pm,h as _m,j as ym,k as Im,l as oi,m as Ul,n as jl,S as Tm,o as Em,C as wm,r as dc,q as Am}from"./index.esm-C6IHFrXA.js";var fc=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ce=new mm("@firebase/firestore");function xn(){return Ce.logLevel}function my(r){Ce.setLogLevel(r)}function N(r,...t){if(Ce.logLevel<=ue.DEBUG){const e=t.map(ia);Ce.debug(`Firestore (${rr}): ${r}`,...e)}}function mt(r,...t){if(Ce.logLevel<=ue.ERROR){const e=t.map(ia);Ce.error(`Firestore (${rr}): ${r}`,...e)}}function Qt(r,...t){if(Ce.logLevel<=ue.WARN){const e=t.map(ia);Ce.warn(`Firestore (${rr}): ${r}`,...e)}}function ia(r){if(typeof r=="string")return r;try{/**
* @license
