...
export default function BounceCards({
  ...
  transformStyles = [
    'rotate(-5.741deg) translate(-380px)',
    'rotate(8.447deg) translate(-150px, 40px)',
    'rotate(-5.078deg) translate(150px, 40px)',
    'rotate(7.687deg) translate(380px)'
  ],
  enableHover = true
}) {
  ...
  }, [animationStagger, easeType, animationDelay, hasAnimated]);
  ...
  // Desktop: use original BounceCards
  return (
    <div
